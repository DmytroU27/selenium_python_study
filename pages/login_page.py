...
class LoginPage(BasePage):
    ...
    def should_be_register_form(self):
        ...
        assert self.is_element_present(*LoginPageLocators.REGISTRATION_PASSWORD1), 'Registration password form is unavailable'
        assert self.is_element_present(*LoginPageLocators.REGISTRATION_PASSWORD2), 'Registration pasword confirm form is unavailable'
